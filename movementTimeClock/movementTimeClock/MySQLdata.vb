...
Module MySQLdata
    ...
    Public Function TodayCount(ByRef employeeInfor) As Boolean
        Dim connect As New MySqlConnection("server=cpu1305189;user id=wfuser;password=wfpass;database=timeclock;SslMode=none")
    ...
    Public Function inoutTxt(ByRef employeeInfor) As Boolean
        ...
        Try
            ...
            If diff_min < 15 Then 'normally no OUT more than 15 minit 
    ...
    Public Function Insertinfo(ByRef employeeInfo) As Boolean
        Dim connectionString As String = "server=cpu1305189;user id=wfuser;password=wfpass;database=timeclock;SslMode=none"
